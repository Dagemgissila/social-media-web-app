  ...
  <div class="bg-white rounded border p-4 mb-3">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-2 mb-3">
      <template v-for="attachment in post.attachments" :key="attachment.id">
        ...
        <div class="group aspect-square bg-blue-100 flex flex-col items-center justify-center relative">

          <!-- download -->
          <button
            class="opacity-0 group-hover:opacity-100 transition-all w-8 h-8 flex items-center justify-center text-gray-100 bg-gray-700 hover:bg-gray-800 rounded  absolute right-2 top-2 cursor-pointer ">
